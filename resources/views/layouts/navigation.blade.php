            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->role === 'guru' || Auth::user()->role === 'admin')
                        ...
                        <x-nav-link :href="route('paket.index')" :active="request()->routeIs('latihan.*') || request()->routeIs('paket.*')">
                            {{ __('Latihan Soal') }}
                        </x-nav-link>
                    ...
                    <x-nav-link :href="route('submit.index')" :active="request()->routeIs('submit.*') ">
                        {{ __('Hasil') }}
                    </x-nav-link>
